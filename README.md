...
|---------------------------------|------------|
| Attendance                      | 10%        |
| Reading Comprehension Exercises | 20%        |
...
I will note your attendance each class or lab session and at the end of the semester your attendance will be converted from a fraction (**# of classes and lab sessions attended / total # of classes and lab sessions**) to a percentage (all percentages will be rounded up to the nearest whole percentage). This attendance grade will make up 10% of your overall grade.
...
| Week | Dates                    | Topics                                                                                                                                       |
|------|--------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| 0    | August 25 - 27           | **Groundwork** <br> Git, GitHub, SSH keys, JupyterLab, basic terminal commands, and Markdown                                                 |
